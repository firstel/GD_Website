...
//     try {
//       // Replace this URL with your Formspree endpoint or API route
...
//             <div className="relative z-10 flex flex-col justify-center h-full px-10 lg:px-16 pt-28 pb-12 lg:pt-32">
//               <h1 className="text-5xl lg:text-7xl font-black text-white uppercase leading-none tracking-tight mb-6">
//                 License
//                 <br />a Title
//               </h1>
//               <p className="text-white/90 text-sm lg:text-base leading-relaxed max-w-md">
//                 Interested in bringing one of our games to your platform, store,
//                 or audience? We work with publishers, distributors, and platform
//                 partners worldwide. Let&apos;s talk.
//               </p>
...
//       {/* ── Body ── */}
//       <div className="container-fluid px-6 lg:px-16 py-16 max-w-6xl mx-auto">
